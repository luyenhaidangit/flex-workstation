...
| `constitution.md` | [constitution.md](../../../.specify/memory/constitution.md) | Không áp dụng | Chưa có gate constitution riêng áp dụng cho module CRUD nền tảng này |
