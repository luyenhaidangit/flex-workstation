...
Spec đạt quality gate và sẵn sàng chuyển sang `$speckit-plan`. Bước plan phải giữ nguyên phạm vi: chỉ điều chỉnh UI/flow hiện có, không triển khai backend draft/versioning và không mở rộng các bước cấu hình chưa được yêu cầu.
