...
- `Status: Fail`: dùng checkbox `[ ]`.
- `Status: Fail (ngoại lệ đã phê duyệt)`: dùng checkbox `[x]`.
- `Status: Không áp dụng`: dùng checkbox `[x]`.
