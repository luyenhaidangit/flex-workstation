...
Không tạo source file trực tiếp tại workspace root, trừ runtime generated config trong `.claude` — vì root `.claude/` là target được generate khi sync; source-of-truth nằm ở `flex-workstation`.
