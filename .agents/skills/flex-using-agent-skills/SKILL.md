...
| `AGENTS.md`, `CLAUDE.md`, `.claude/rules/`, decisions about persistent agent context, or a request to review/improve a specific project's context | `flex-context-engineering` |
