...
- Công cụ bắt buộc hoặc khuyến nghị cho người mới nên được đưa vào `scripts/bootstrap.ps1`, entrypoint thân thiện nên đặt tại `SETUP_WORKSTATION.cmd` hoặc `OPEN_WORKSPACE.cmd`, và ghi lại tại `docs/onboarding.md`.
